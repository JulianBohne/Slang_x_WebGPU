...
(async () => {
  ...
  gui_container.appendChild(document.createElement('span')).textContent = 'Position';
  ...
  gui_container.appendChild(document.createElement('span')).textContent = 'Scale';
  ...
  gui_container.appendChild(document.createElement('span')).textContent = 'Rotation';
  ...
  gui_container.appendChild(document.createElement('span')).textContent = 'Color';
  ...
  gui_container.appendChild(document.createElement('span')).textContent = 'Opacity';
